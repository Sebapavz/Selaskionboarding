...
(function () {
  ...
  function stopDrag(){
    ...
    var top=r.top;
    // Snap side based on which half of screen
  ...
  function render(){
    ...
    var hd=document.getElementById('slk-hd');
    if(hd){hd.addEventListener('mousedown',startDrag);hd.addEventListener('touchstart',startTouch,{passive:true});}
